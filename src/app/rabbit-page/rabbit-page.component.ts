...
@Component({
  selector: 'app-rabbit-page',
  templateUrl: './rabbit-page.component.html',
  styleUrl: './rabbit-page.component.css',
})
export class RabbitPageComponent {
  constructor(private entityService: entityService) {}

  inputText: string = ''; // Bound to the input field
  submittedText: string | null = null; // Stores the submitted value
